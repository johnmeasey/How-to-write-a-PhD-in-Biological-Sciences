...
In addition to this chapter, there is some good information out there on the web, and it's worth looking at this too: (e.g. [Wikihow](https://www.wikihow.com/Write-a-Hypothesis), [Wikipedia](https://en.wikipedia.org/wiki/Hypothesis), etc.). There's also some less good stuff out there, so read critically.
