...
### Avoid HARKing 
Hypothesising After Results Known (HARKing) is the practice of creating your hypothesis once the results are in and you’ve done some preliminary data analyses to see what is significant [@forstmeier2017detecting]. HARKing has become prevalent in science because of the confirmation bias by journals (only accepting papers that can statistically accept the alternative hypothesis), especially those with higher impact factor.
