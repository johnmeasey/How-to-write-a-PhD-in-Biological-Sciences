...
The corresponding references in [Vancouver](vancouver.html) format are in the section on [references](references.html).
...
You can find the corresponding references in [Harvard](harvard.html) format in the [references](references.html) section.
...
Another common mistake is to forget which paper has which information. You can try to make sure that you don’t do this by taking better notes or a more accurate plan. And do the citations before or as you write, not afterwards!
