...
Plant taxonomy is considered the taxonomic mother discipline as the work of Linneaus in 1753 was the first botanical work that consistently used Linneus' binomial (two names: Genus species) nomeclatural system [@linnaeus1753species] which pre-dated the more inclusive (and better known) landmark publication in 1758 [@linnaeus1758systema]. Until the Botanical Code was revised in 2012, all new botanical diagnoses had to be written in Latin. In addition to the Latin binomial name (Genus and species), plants (and some other taxa) often require further descriptors or **ranks** that denote subspecies, varieties, subvareties, etc. I have included a (non-exhaustive) list of these in Table \@ref(tab:plantrank), together with some examples. 
