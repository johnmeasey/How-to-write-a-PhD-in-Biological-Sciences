...
Although we talk about writing science here, the grammatical rules of writing (in English) are fairly universal (with some local exceptions), so do practice your writing. Maybe write a letter (or long email) instead of making a call. It'll also help you to [read critically](critical.html). If you are a keen reader, then you could do worse than reading some Kurt Vonnegut [-@vonnegut1980how].
