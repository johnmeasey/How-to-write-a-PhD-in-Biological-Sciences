...
Your final thesis will be a set of papers (data chapters sandwiched between an [introduction and discussion](#PhDintro)), and so prepare the proposal in the same way. That is, you will normally have two (MSc) or five (PhD) data chapters. In the proposal, each chapter will consist of three parts.

## Proposal introduction

I’m not going to go into what’s inside the introduction here, as it’s already been done in other chapters on formulaic writing (see later in this [part](#formula)) and specifically about the introduction (see [part 3](#introduction)). Although you may feel that there's no point putting a lot of effort into this introduction it serves as a literature review for your upcoming PhD study, and is well worth the time and effort. 

A key part of the introduction will be your [conceptual framework](#concept) that will explain how your thesis chapters fit together, and crucially, add up to more than a sum of their parts.

## Methods and Materials

What’s in the [Methods and Materials](#methods) section is also covered here. Essentially you need to:
...
- You must explicitly state how each of the variables (introduced in the [introduction](#introduction)) is collected
- (If necessary) Describe how you’ll turn your collected data into the variables needed for your analyses
- Data analyses (how you’ll test your [hypotheses](#hypothesis)). This should include a description of the statistical or analytical techniques. It’s useful to structure this section by each of the questions/hypotheses that you are posing
...
You should be able to state from the outset when you are going to find the time to fit in all of the components of your thesis. Being able to plan when and how you will do the work is a key aspect of your proposal. I discuss how to construct a [timeline](#Gendt) in the form of a Gendt diagram in another chapter (see [Part II](#Gendt)).
...
Writing grant proposals is essentially the same as your thesis proposal, and so you can use this document (with some modifications to tailor it to the grant objectives) to [raise money](#funding) for your work. 

### Deposit the proposal to conform to Design and Analysis Transparency

This is the subject of another chapter (see [part 3](#transparency)).
