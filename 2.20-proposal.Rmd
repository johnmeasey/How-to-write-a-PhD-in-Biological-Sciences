...
We expect that your final thesis will be a set of papers (data chapters sandwiched between an [introduction and discussion](PhDintro.html)), and so we ask you to prepare the proposal in the same way. That is, you will normally have two (MSc) or five (PhD) data chapters. In the proposal, each chapter will consist of three parts:
