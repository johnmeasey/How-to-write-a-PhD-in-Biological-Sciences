...
If you are interested in reading more about titles and how people use them, there is some interesting analysis out there to get you started [e.g. @soler2007writing, @jamali2011article, @cook2016scholars, @krausman2020writing]. Remember that title type and use does vary by discipline, so it would be worth being aware of what is generally used in the journals that you intend to target.
...
-   The shorter and catchier your title can be the better: 6 words (±1) is an ideal.
    ...
    -   Allow yourself a longer subtitle if needed, but don't go over 20 words total (some journals may limit your total to less). 
        -   Titles is a colon are downloaded and cited less [@jamali2011article].
    -   Artiles with longer titles are downloaded less [@jamali2011article].
...
-   Don't feel obliged to include [taxonomic terms](#taxonomy) unless it
    is relevant or compulsory [see @krausman2020writing]
...
-   Avoid obscure or specialist words that won't be understood by your
    readership [@krausman2020writing]
...
-   Don't use an implicit words in the title: a study of..., the effect of..., factors affecting..., etc. [@krausman2020writing].  

-   Don't imply a series of works (e.g. Part I) [@krausman2020writing].

-   Don't be too funny. Sagi and Yechiam [-@sagi2008amusing] found that highly amusing titles got less citations.
...
### Should your title have a question?

[Betteridge's Law](https://web.archive.org/web/20090226202006/http://www.technovia.co.uk/2009/02/techcrunch-irresponsible-journalism.html) relates to newspaper headlines and the idea that any headline that is a question is most simply answered by a single word "No" even though the writer has written the question with the expectation that readers will be interested in their explanation of why the answer is "Yes". In academic circles, this same idea is known as Hinchcliffe’s Rule: “If the title of a scholarly article is a yes–no question, the answer is ‘no’” [@shieber2015this]. The concern in both studies is that simple questions are being used as 'click-bait' to encourage potential readers to discover the simple answer. Indeed, there is some evidence that using a question in the title results in more downloads but less citations [@jamali2011article].

Ball [-@ball2009scholarly] found that the use of question marks in titles has been steadily rising in the life-sciences over 40 years. His assumption is that, like a newspaper headline, using a question in the title is a way of the authors trying to market the contents of their article. Cook and Plourde [-@cook2016scholars] analysed nearly 8000 titles (although not in the Biological Sciences) for Betteridge’s Law and Hinchcliffe’s Rule, but found that academics in the disciplines they analysed did not conform to either. 
