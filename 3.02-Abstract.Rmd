...
The abstract is a concise paragraph that sums up the major points of your manuscript so that the potential reader will be able to assess whether or not they want to read the entire paper. It is an abstract of the entire document. 
...
None of this is easy, and you should not expect to write your abstract in a single sitting. It will likely require multiple iterations, and some intense word-smithing to make it as good as it can be. Abstracts almost always have a word limit, and that makes it challenging and means that you have to be concise [see part 2](#concise).
