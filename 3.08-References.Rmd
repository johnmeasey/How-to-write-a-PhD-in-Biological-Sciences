...
A [DOI](https://www.doi.org/) is an [ISO](https://www.iso.org/) unique character string to identify physical, digital or abstract objects. Their beauty is that they are persistent over time, so once issued they will always be a way to reach a particular object. 
...
There's also an equally useful database that provides BibTex for DOIs that you enter: [doi2bib.org](https://doi2bib.org/)
