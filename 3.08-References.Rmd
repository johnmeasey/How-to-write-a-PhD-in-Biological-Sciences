...
The references below are exactly the same as those above, but follow the [Harvard](#citations) referencing format. The order of these references is alphabetical. If a paper has the same authors the oldest paper usually comes before subsequent papers. 
