...
Next, produce a hierarchy of hypotheses for all of the chapters and concepts in your thesis (see Figure \@ref(fig:JeschkeHagar61)). This will help you to make sure that you cover all of the [big ideas](#bigidea) and concepts in the outline. Your outline should follow the standard funnel [formula](#formula) (see Figure \@ref(fig:introduction)) this time with the highest level ideas in your hierarchy of hypotheses given full prominence in the first paragraph. 
