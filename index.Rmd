...
# Under Contract {-}
This book is currently under contract with CRC Press. 
```{r fig.align='center', echo=FALSE, include=identical(knitr:::pandoc_to(), 'html'), fig.link='http://john.measey.com/Writing_Publishing'}
